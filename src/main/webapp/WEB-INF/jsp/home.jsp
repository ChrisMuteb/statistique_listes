            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select bg-white border-secondary-subtle" id="departement" name="departement" required>
                        ...
                        <option value="974" selected>974 - La Réunion</option>
                        </select>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select bg-white border-secondary-subtle" id="typeRequete" name="typeRequete" required>
                        <option value="fiches_anomalie" selected>Fiches en anomalie</option>
                        <option value="statistiques_globales">Statistiques globales</option>
                    </select>
                </div>
            </div>
